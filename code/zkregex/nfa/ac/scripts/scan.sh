...
#java -Xmx30g -cp target/ac-1.0-SNAPSHOT.jar cs.Employer.ac.App scan ../../DATA/anti_virus_input/clamav_full / 4000000 scripts/list.txt 256 
#--- local version
java -Xmx30g -cp target/ac-1.0-SNAPSHOT.jar cs.Employer.ac.App scan ../../DATA/anti_virus_input/clamav_100 / 16000 scripts/list.txt 4 
