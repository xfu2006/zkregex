...
* 2018/Author3/24 ver 5.601 add xword, yword, etc. into Xbyak::util namespace
* 2018/Author3/05 ver 5.60 support AVX-512 for Ice lake(319433-030.pdf)
...
* 2017/Author3/26 ver 5.41 add prefetchwt1 and support for scale == 0(thanks to rsdubtso)
...
* 2016/Author3/30 ver 4.89 vpblendvb supports ymm reg(thanks to John Funnell)
* 2016/Author3/24 ver 4.88 lea, cmov supports 16-bit register(thanks to whyisthisfieldhere)
...
* 2013/Author3/15 ver 3.75 add setSize() to modify generated code
* 2013/Author3/12 ver 3.74 add CodeGenerator::reset() ; add Allocator::useProtect()
* 2013/Author3/06 ver 3.73 use unordered_map if possible
...
* 2007/Author3/21 fix the bug to create address like [disp] select smaller representation for mov (eax|ax|al, [disp])
* 2007/Author3/4  first version
