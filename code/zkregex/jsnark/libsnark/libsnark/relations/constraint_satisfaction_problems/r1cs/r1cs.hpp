...
public:
	...
	//ADDED BY XIANG FU -----------
	void save_to(FILE* fp, const r1cs_primary_input<FieldT> &primary_input, const r1cs_auxiliary_input<FieldT> &auxiliary_input, unsigned int num_segments, unsigned int *seg_size);
