...
/*************************************************************
	Simple Mul Generator + Equality Comparison for LongElement (2048 bits)
* *************************************************************/
...
public class LongEleMulGen extends CircuitGenerator {

	private Wire[] inputs;

	public LongEleMulGen() {
		super("LongEleMul");
	}
