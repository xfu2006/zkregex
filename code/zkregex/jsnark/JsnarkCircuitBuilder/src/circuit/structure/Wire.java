...
public class Wire implements Serializable{
	...
	/** only valid for witness wires, by default it takes the DEFAULT_WITNESS_SEMENT_ID value of the genreator */
	protected int segment_id;
...
//Added by CorrAuthor ----------------
		if(generator==null){
			throw new RuntimeException("Wire::generator is null!");	
		}
//Added by CorrAuthor ---------------- ABOVE
		...
		this.wireId = wireId;
		this.segment_id = generator.getDefaultWitnessSegmentID();
	}
