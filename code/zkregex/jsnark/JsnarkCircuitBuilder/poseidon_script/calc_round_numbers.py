...
print("[R_F, R_P, min_sbox_cost, min_size_cost]");

print("\nLibsnark");
print("n = 254; t = 3; alpha = 5; M = 256");
print(calc_final_numbers_fixed(Crypto.Util.number.getPrime(254), 3, 5, 256, True))
print("****n = 254; t = 2; alpha = 5; M = 256");
print(calc_final_numbers_fixed(Crypto.Util.number.getPrime(254), 2, 5, 256, True))
print("***n = 254; t = 2; alpha = 5; M = 128");
print(calc_final_numbers_fixed(Crypto.Util.number.getPrime(254), 2, 5, 128, True))
print("n = 254; t = 1; alpha = 5; M = 256");
print(calc_final_numbers_fixed(Crypto.Util.number.getPrime(254), 1, 5, 256, True))
print("n = 254; t = 3; alpha = 5; M = 128");
print(calc_final_numbers_fixed(Crypto.Util.number.getPrime(254), 3, 5, 128, True))

print("\nSpartan");
print("n = 253; t = 3; alpha = 5; M = 256");
print(calc_final_numbers_fixed(Crypto.Util.number.getPrime(253), 3, 5, 256, True))
print("n = 253; t = 2; alpha = 5; M = 256");
print(calc_final_numbers_fixed(Crypto.Util.number.getPrime(253), 2, 5, 256, True))
print("n = 253; t = 3; alpha = 5; M = 128");
print(calc_final_numbers_fixed(Crypto.Util.number.getPrime(253), 3, 5, 128, True))
