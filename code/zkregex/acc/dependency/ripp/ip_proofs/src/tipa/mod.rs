...
impl<G: ProjectiveCurve> TIPACompatibleSetup for PedersenCommitment<G> where
G: VariableBaseMSM<MSMBase = G::Affine, Scalar = G::ScalarField>
{}
...
where <P as PairingEngine>::G1Projective: VariableBaseMSM<MSMBase=<P as PairingEngine>::G1Affine, Scalar=<P as PairingEngine>::Fr>
{
    ...
    IPC::Output: MulAssign<P::Fr>,
{
	...
	where <P as PairingEngine>::G1Projective: VariableBaseMSM<MSMBase=<P as PairingEngine>::G1Affine, Scalar=<P as PairingEngine>::Fr>{
        ...
        Ok((
            SRS {
                ...
                g_beta: g.mul(beta.into_bigint()),
                h_alpha: h.mul(alpha.into_bigint()),
            },
	...
	where <P as PairingEngine>::G1Projective: VariableBaseMSM<MSMBase=<P as PairingEngine>::G1Affine, Scalar=<P as PairingEngine>::Fr>,
	<P as PairingEngine>::G2Projective: VariableBaseMSM<MSMBase=<P as PairingEngine>::G2Affine, Scalar=<P as PairingEngine>::Fr>
	{
...
pub fn verify_commitment_key_g2_kzg_opening<P: PairingEngine>(
    ...
    Ok(P::pairing(
        v_srs.g,
        *ck_final - &v_srs.h.mul(ck_polynomial_c_eval.into_bigint()),
    ) == P::pairing(
        v_srs.g_beta - &v_srs.g.mul(kzg_challenge.into_bigint()),
        *ck_opening,
    ))
}
...
pub fn verify_commitment_key_g1_kzg_opening<P: PairingEngine>(
    ...
    let ck_polynomial_c_eval =
        polynomial_evaluation_product_form_from_transcript(transcript, kzg_challenge, r_shift);
    Ok(P::pairing(
        *ck_final - &v_srs.g.mul(ck_polynomial_c_eval.into_bigint()),
        v_srs.h,
    ) == P::pairing(
        *ck_opening,
        v_srs.h_alpha - &v_srs.h.mul(kzg_challenge.into_bigint()),
    ))
}
